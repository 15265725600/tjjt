...
function preUrl(path) {
  ...
  //  var fUrl = 'http://www.jintaiwei.cn/hm_tjjt/';
  return fUrl + path;
}

function newUrl(path) {
  var fUrl = 'http://localhost:8080/hm_tjjt/';
  //  var fUrl = 'http://www.jintaiwei.cn/hmapi_jintai/v100/';
  return fUrl + path;
}
